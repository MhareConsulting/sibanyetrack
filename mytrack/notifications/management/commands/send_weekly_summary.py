...
from mytrack.notifications.emails import send_weekly_summary


class Command(BaseCommand):
    help = "Send weekly fleet and safety summary emails (run weekly via cron, e.g. Monday)"
    ...
    def handle(self, *args, **options):
        ...
        results = send_weekly_summary(dry_run=dry_run)
